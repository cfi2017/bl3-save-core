...
func Decrypt(reader io.Reader) (shared2.SavFile, []byte) {
	s, data := shared2.DeserializeHeader(reader)
	return s, shared2.Decrypt(data, prefixMagic, xorMagic)
}

func Deserialize(reader io.Reader) (shared2.SavFile, pb.Profile) {
...
func Serialize(writer io.Writer, s shared2.SavFile, p pb.Profile) {
	...
	bs = shared2.Encrypt(bs, prefixMagic, xorMagic)
